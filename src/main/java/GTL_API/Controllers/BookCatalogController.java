...
public class BookCatalogController {
    ...
    public ResponseEntity<?> getAvailableBooks(@PathVariable int page) {
        return new ResponseEntity<>(iAvailableBooksService.getAvailableBooks(page), new HttpHeaders(), HttpStatus.FOUND);
    }
    ...
    public ResponseEntity<?> findAvailableByCatalogId(@PathVariable int catalogId) {
        return new ResponseEntity<>(iAvailableBooksService.findAvailableByCatalogId(catalogId), new HttpHeaders(), HttpStatus.FOUND);
    }
    ...
    public ResponseEntity<?> getAvailableBooksByIsbn(@PathVariable String isbn) {
        return new ResponseEntity<>(iAvailableBooksService.getAvailableBooksByIsbn(isbn), new HttpHeaders(), HttpStatus.FOUND);
    }
}
